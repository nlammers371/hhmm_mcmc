...
mcmcInfo.n_temps_per_chain = 6; % number of rungs in the temperature ladder for each chain
...
mcmcInfo.n_rs_per_trace = 0; % number of swap proposals per neighboring trace pair
