...
elements = {n_chains_vec mem_vec nStates_vec simVec};
...
for n = 1:n_blocks
    ...
    parfor iter = iter_min:iter_max
        ...
        % save results
        saveString = ['K' sprintf('%01d',nStates) '_W' sprintf('%03d',10*round(nSteps,1)) '_nc' sprintf('%03d',n_chains) '_rep' sprintf('%03d',rep_num)];
