...
%     mcmcInfo.sample_chains(curr_lin_index_array) = sum(rand_array > option_array) + 1;
    sample_chains_temp(prev_time_index_array+1) = sum(rand_array > option_array) + 1;
%     for c = 1:n_chains
%         for t = 1:n_traces
%             mcmcInfo.sample_chains(mcmcInfo.indArray(1,c,t),c,t) = randsample(1:nStates,1,true,total_likelihoods(:,c,t));
%         end
%     end
    ...
    mcmcInfo.sample_chains_dummy(curr_lin_index_array) = sample_chains_temp(prev_time_index_array+1);
