...
for i = 1:seq_length
    ...
    row_col_array_post = (mcmcInfo.row_ref-1)*nStates+post_state_array;
        
    % extract probabilities
    post_probs_log = A_log(row_col_array_post);
    ...
    curr_lin_index_array = mcmcInfo.indArray + mcmcInfo.chain_id_ref*seq_length + mcmcInfo.trace_id_ref*seq_length*n_chains;
