function local_em_outputs = local_em_MS2_reduced_memory_timer (fluo_values, ...
              v, noise, pi0_log, A_log, K, w, kappa, n_steps_max, eps)

    % NL: edited version made on 2022.04.21 to time BW cycles 
...
%                                allowed_from_n(:, column_ind), d_n_list');
    ...
    local_em_outputs = struct('pi0_log', pi0_log, 'A_log', A_log, ...
        ...
        'soft_struct', soft_struct,'em_time_vec', em_time_vec);