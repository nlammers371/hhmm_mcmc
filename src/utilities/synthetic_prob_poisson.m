function synthetic_data = synthetic_prob_poisson(seq_length, alpha, K, w, A, ...
                                         v, noise, pi0)
    ...
    for t = 2:seq_length
        ...
        emissions(t) = poissrnd(v(naive_states(t)));
    end  
    ...
    synthetic_data = struct('fluo', fluo_noise, 'fluo_MS2', fluo_MS2_noise, ...
        ...
        'naive_states', naive_states ,'loading_events', emissions);